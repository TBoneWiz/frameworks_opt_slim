...
public class DisplayRotation extends SettingsPreferenceFragment implements OnPreferenceChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        int mode = SlimSettings.System.getInt(getContentResolver(),
                        SlimSettings.System.ACCELEROMETER_ROTATION_ANGLES,
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        if (preference == mAccelerometer) {
            ...
            SlimSettings.System.putInt(getContentResolver(),
                    SlimSettings.System.ACCELEROMETER_ROTATION_ANGLES, mode);
            return true;
        }
