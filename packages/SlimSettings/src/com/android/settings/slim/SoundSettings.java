...
public class SoundSettings extends SettingsPreferenceFragment implements
    ...
    protected int getMetricsCategory() {
        return SlimMetricsLogger.APPLICATION;
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSafeHeadsetVolume.setChecked(SlimSettings.System.getInt(getContentResolver(),
                SlimSettings.System.SAFE_HEADSET_VOLUME, 1) != 0);
        mSafeHeadsetVolume.setOnPreferenceChangeListener(this);

        mAnnoyingNotifications = (ListPreference) findPreference(PREF_LESS_NOTIFICATION_SOUNDS);
        int notificationThreshold = SlimSettings.System.getInt(getContentResolver(),
                SlimSettings.System.MUTE_ANNOYING_NOTIFICATIONS_THRESHOLD, 0);
    ...
    public boolean onPreferenceChange(Preference preference, Object objValue) {
        ...
        if (KEY_SAFE_HEADSET_VOLUME.equals(key)) {
            if ((Boolean) objValue) {
                SlimSettings.System.putInt(getContentResolver(),
                        SlimSettings.System.SAFE_HEADSET_VOLUME, 1);
            } else {
 	   ...
 	   if (PREF_LESS_NOTIFICATION_SOUNDS.equals(key)) {
            ...
            SlimSettings.System.putInt(getContentResolver(),
                    SlimSettings.System.MUTE_ANNOYING_NOTIFICATIONS_THRESHOLD, val);
        }
        return true;
    }
                ...
                case DLG_SAFE_HEADSET_VOLUME:
                    ...
                    .setPositiveButton(R.string.dlg_ok,
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            SlimSettings.System.putInt(getOwner().getContentResolver(),
                                    SlimSettings.System.SAFE_HEADSET_VOLUME, 0);
                        }
                    })
